...
api_list = [
    {
        ...
        # relation-* [u'insect', u'bug', u'butterfly', u'flower', ...]
        'base_url': "https://twinword-visual-context-graph.p.mashape.com/",
        'headers': headers,
        'uri_list': ['visualize'],
        'exclude': [
            'author', 'result_msg', 'request', 'email', 'version',
            'entry', 'response', 'result_code'
        ],
        'transform': [transform_relation],
    },
    {
        # associations_array  [u'termite', u'bee', u'insect', u'cockroach' ...]
        'base_url': "https://twinword-word-associations-v1.p.mashape.com/",
        'headers': headers,
        'uri_list': ['associations'],
        'exclude': [
            'author', 'result_msg', 'request', 'email', 'version', 'entry',
            'response', 'result_code', 'associations', 'associations_scored'
        ],
        'transform': [],
    },
    {
        ...
        # 2->1
        # 3
        # example [u'Ant is a hard working insect.', u'The larval ...', ...]
        # 4
        # relation-associations ---
        # relation-broad_terms u'hymenopterous insect, hymenopter',
        # relation-derived_terms: u''
        # relation-evocations: u'social insect',
        # relation-narrow_terms: u"wood ant, slave-making ant, slave-maker,
        ...
        'headers': headers,
        'uri_list': [
            'association', 'definition', 'definition_kr',
            'example', 'reference', 'theme'
        ],
        'exclude': [
            'author', 'result_msg', 'request', 'email', 'version',
            'entry', 'response', 'result_code', 'ipa'
        ],
        'transform': [],
    }
]
...
def get_api_result(word, api_num=None, uri_num=None):
    ...
    cache, created = ApiCallCache.objects.get_or_create(**args)
